...
public class XSPPage extends DCPanel implements XSPAllPropertyConstants {
    ...
    private String[] themeStarterCodes = {"", "webstandard", "oneui", "oneuiv2", "oneuiv2.1", "oneuiv3.0.2"}; // $NON-NLS-1$ $NON-NLS-2$ $NON-NLS-3$ $NON-NLS-4$ $NON-NLS-5$
    private String[] sysThemeStarterLabels = {PLATFORM_DEFAULT, "webstandard", "OneUI", "OneUI V2", "OneUI V2.1", "OneUI V3.0.2"}; // $NLX-XSPPage.webstandard_sys-1$ $NLX-XSPPage.OneUI_sys-2$ $NLX-XSPPage.OneUIV2_sys-3$ $NLX-XSPPage.OneUIV21_sys-4$ $NLX-XSPPage.OneUIV302_sys-5$
    private String[] appThemeStarterLabels = {APP_DEFAULT, "webstandard", "OneUI", "OneUI V2", "OneUI V2.1", "OneUI V3.0.2"}; // $NLX-XSPPage.webstandard_app-1$ $NLX-XSPPage.OneUI_app-2$ $NLX-XSPPage.OneUIV2_app-3$ $NLX-XSPPage.OneUIV21_app-4$ $NLX-XSPPage.OneUIV302_app-5$
    
    private String[] mobileStarterCodes = {"", "oneui_idx_v1.3"}; // $NON-NLS-1$
    private String[] mobileThemeStarterLabels = {MOBILE_DEFAULT, "OneUI IDX V1.3"};  // $NLX-XSPPage.OneUIIDXV13-1$
    
    private String[] mobileIPhoneStarterCodes = {"", "oneui_idx_v1.3", "iphone"}; // $NON-NLS-1$ $NON-NLS-2$
    private String[] mobileThemeIPhoneStarterLabels = {APP_DEFAULT, "OneUI IDX V1.3", "iPhone"};  // $NON-NLS-2$ $NLX-XSPPage.OneUIIDXV13-1$ 
    private String[] mobileAndroidStarterCodes = {"", "oneui_idx_v1.3", "android"}; // $NON-NLS-1$ $NON-NLS-2$
    private String[] mobileThemeAndroidStarterLabels = {APP_DEFAULT, "OneUI IDX V1.3", "Android"}; // $NON-NLS-2$ $NLX-XSPPage.OneUIIDXV13-1$ 
    ...
    public XSPPage(Composite parent, FormToolkit ourToolkit, XSPParentEditor dpe) {
        ...
        atl = new AppThemeLookup(ourEditor.getDominoDesignerProject(), themeStarterCodes, sysThemeStarterLabels);
        atl2 = new AppThemeLookup(ourEditor.getDominoDesignerProject(), themeStarterCodes, appThemeStarterLabels);
        matl = new AppThemeLookup(ourEditor.getDominoDesignerProject(), mobileStarterCodes, mobileThemeStarterLabels);
        matlIPhone = new AppThemeLookup(ourEditor.getDominoDesignerProject(), mobileIPhoneStarterCodes, mobileThemeIPhoneStarterLabels);
        matlAndroid = new AppThemeLookup(ourEditor.getDominoDesignerProject(), mobileAndroidStarterCodes, mobileThemeAndroidStarterLabels);
        
        // GarMaj - Remove duplicates for GGRD9AZKLA and GGRD9BFN7G
        matl.removeDuplicateStartLabels();        
        matlIPhone.removeDuplicateStartLabels();
        matlAndroid.removeDuplicateStartLabels();
