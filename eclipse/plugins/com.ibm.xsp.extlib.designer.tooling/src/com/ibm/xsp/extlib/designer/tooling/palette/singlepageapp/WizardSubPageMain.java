...
public class WizardSubPageMain extends WizardSubPage {
    ...
    private Button          resetContentBtn;
    ...
    public void createControl(Composite parent) {
        ...
        if (pageData.type == WizardData.PAGE_TYPE_FORM) {
            ...
            topBtn = WizardUtils.createRadio(tabBarGroup, "Top", 1, null);  // $NLX-WizardSubPageMain.Top-1$
    ...
    public boolean getSubPagePreLoad() {
        if(preloadBtn == null) {
            return false;
        }
        return preloadBtn.getSelection();
    }

    public boolean getSubPageResetContent() {
        if(resetContentBtn == null) {
            return true;
        }
        return resetContentBtn.getSelection();
    }
    ...
    public boolean getSubPageBackBtn() {
        ...
        return backBtn.getSelection();
    }

    public String getSubPageBackText() {
        if(backLabel == null) {
            return "Back"; // $NLX-WizardSubPageMain.Back.1-1$
        }
    ...
    public boolean getSubPageTabBar() {
        if(tabBarBtn == null) {
            return (pageData.type == WizardData.PAGE_TYPE_FORM);
        }
        return tabBarBtn.getSelection();
    }
    ...
    public String[] getSubPageTabBtns() {
        ...
        String[] parts = tabBtnText.getText().split(",");
    ...
    public String [] getSubPageToolBarBtns() {
        ...
        String[] parts = toolBarText.getText().split(",");
        for (int i=0; i<parts.length; i++) {
            parts[i] = parts[i].trim();
        }
        return parts;
    ...
    public boolean getNewDocBtn() {
        if (newDocBtn == null) {
            return (pageData.type == WizardData.PAGE_TYPE_VIEW);
        }
        
        return newDocBtn.getSelection();
    }
    
    public boolean getEditSaveDocBtn() {
        if (editSaveDocBtn == null) {
            return (pageData.type == WizardData.PAGE_TYPE_FORM);
        }
        
        return editSaveDocBtn.getSelection();
    }

    public boolean getDeleteDocBtn() {
        if (deleteDocBtn == null) {
            return (pageData.type == WizardData.PAGE_TYPE_FORM);
        }
        
        return deleteDocBtn.getSelection();
    }
    
    public int getTabBarPosition() {
        if (topBtn == null) {
            return (pageData.type == WizardData.PAGE_TYPE_FORM ? WizardData.TAB_BAR_BOTTOM : WizardData.TAB_BAR_TOP);
        }
        
        if (topBtn.getSelection()) {
