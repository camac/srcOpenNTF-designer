...
public class WizardSubPageDataView extends WizardSubPage {
    ...
    public String getSummaryCol() {
        if ((summaryCombo != null) && (colNames != null)) {
            if (summaryCombo.getSelectionIndex() >= 0) {
                return colNames[summaryCombo.getSelectionIndex()];
            }
        }
    ...
    public String getInfiniteScroll() {
        if (infiniteEnabled != null) {
            if (infiniteDisabled.getSelection()) {
                return "disable"; // $NON-NLS-1$
            }
            if (infiniteAppDef.getSelection()) {
                return "";
            }
        }
