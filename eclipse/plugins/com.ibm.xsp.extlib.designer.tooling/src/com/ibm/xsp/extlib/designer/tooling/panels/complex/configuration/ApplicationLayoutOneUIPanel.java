...
public class ApplicationLayoutOneUIPanel extends DynamicPanel {
  ...
  private void createThemeCombo() {
      ...
      AppThemeLookup lookup = new AppThemeLookup(getExtraData().getDesignerProject(), AppThemeLookup.themeStarterCodes, AppThemeLookup.sysThemeStarterLabels); 
      ...
      // if it's not set, default to OneUIV2.1
