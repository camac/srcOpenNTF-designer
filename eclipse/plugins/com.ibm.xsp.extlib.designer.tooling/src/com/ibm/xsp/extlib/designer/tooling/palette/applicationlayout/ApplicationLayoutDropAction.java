...
public class ApplicationLayoutDropAction extends XPagesPaletteDropActionDelegate {
    ...
    protected Element createElement(Document doc, String prefix) {
        ...
        if (shouldContinue) {
            element = openConfigurationDialog(doc, prefix, isCustom);
        }
        return element;
    }
    ...
    private Element openConfigurationDialog(Document doc, String prefix, boolean isCustomControl) {
        ...
        ApplicationLayoutDropDialog dialog = new ApplicationLayoutDropDialog(shell, panelData, isCustomControl);
